...
bot.addListener('join', function (event) {
  ...
  if (who !== bot.user.nick) {
    ...
    bot.say(who, 'The commands :help will give you more info and :coin? will check to see if your account is old enough to qualify.')
  }
})
...
function handlePrivateMessage (event) {
  ...
  if (text.match(/:coin/)) {
    ...
    bot.say(from, 'Hmmm, did you mean to say please? Or :help? Or :coin?')
  }
}
